...
public class FifteenPuzzle
{
	 ...
	 * <code>-solution</code> parameter, the program uses this default goal
	 * layout:
	 * <P>
	 * <TABLE BORDER=1>
	 * <TR><TD ALIGN="RIGHT">&nbsp;</TD><TD ALIGN="RIGHT">1</TD><TD ALIGN="RIGHT">2</TD><TD ALIGN="RIGHT">3</TD></TR>
	 * <TR><TD ALIGN="RIGHT">4</TD><TD ALIGN="RIGHT">5</TD><TD ALIGN="RIGHT">6</TD><TD ALIGN="RIGHT">7</TD></TR>
	 * <TR><TD ALIGN="RIGHT">8</TD><TD ALIGN="RIGHT">9</TD><TD ALIGN="RIGHT">10</TD><TD ALIGN="RIGHT">11</TD></TR>
	 * <TR><TD ALIGN="RIGHT">12</TD><TD ALIGN="RIGHT">13</TD><TD ALIGN="RIGHT">14</TD><TD ALIGN="RIGHT">15</TD></TR>
	 * </TABLE>
	 * </P>
	 *
	...
	/**
	 * Usage: $ java nl.vu.pp.FifteenPuzzle -bound 20 -board board.txt [-solution solution.txt]
	 *
	 */
	private void _main(String[] argv) throws Exception
	{
		...
		if(argv.length < 2)
		{
			System.out.println("Usage: $ java nl.vu.pp.FifteenPuzzle -board board.txt [-solution goal.txt]");
			System.exit(1);
		}
		...
		System.out.println("Solving 15-puzzle sequentially.\n");
		...
		while(solutions == 0)
		{
			...
			new Job(board, solution, bound).solve();
			bound += 2;
		}

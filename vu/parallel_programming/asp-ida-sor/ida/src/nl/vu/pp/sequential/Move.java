...
public class Move
{
	...
	/**
	 * Returns the total number of Move objects that have been created
	 * (except for the "root move", that is not really a move in the sense
	 * that it doesn't describe a new move to make). <BR>
	 * After a puzzle has been solved, it shows the total number of moves
	 * it took to solve the game and may be used to verify optimizations.
	 * <P>
	 *

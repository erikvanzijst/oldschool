...
#	define SET_PROFILE 7	/* fcn code to CLOCK, enable profiling */
#	define GET_PROFILE 8	/* fcn code to CLOCK, get profile */
...
/* Field names for profiling. */
#define PROF_PROC      m1_i1    /* process id to be profiled or process number
                                 * of the process requesting profile data */
#define PROF_ADDR1     m1_i2    /* start address of process to be profiled */
#define PROF_ADDR2     m1_i3    /* end address of process to be profiled */
#define PROF_DATA      m1_p1    /* pointer to profile data */

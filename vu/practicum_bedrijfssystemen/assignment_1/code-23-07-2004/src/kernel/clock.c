 ...
 */
  ...
  {
    /* process is runnable */
    if (prof_data.end_addr == 0)
    {
      /* auto set end address */
      if (prof_proc->p_map[T].mem_len != 0) 
        /* separate I&D */
        prof_configure(0, (prof_proc->p_map[T].mem_len * CLICK_SIZE) - 1);
      else
        /* combined I&D */
        prof_configure(0, (prof_proc->p_map[D].mem_len * CLICK_SIZE) - 1);
    }

...
#define ORBIT_TIME_F16 2.0
#define ORBIT_F16 3.0
#define MATRIX_ON 1
#define BEDUG 1
...
static const char* f16_files[9] = {(char *)"f-16\\afterburner.sgf", (char *)"f-16\\body.sgf", (char *)"f-16\\bomb.sgf",
		(char *)"f-16\\cockpit.sgf", (char *)"f-16\\rockets.sgf", (char *)"f-16\\tailfin.sgf",
		(char *)"f-16\\tailwings.sgf", (char *)"f-16\\wings.sgf", (char *)""};

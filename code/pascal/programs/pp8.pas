...
{----------------------------------------------------------------------}
PROCEDURE BerekenMetEuler{Voeg zelf de parameters toe.};
...
{Neem hier de variabeledeclaratie op.}
  ...
  REPEAT
    ...
    CASE keuzenr OF
      ...
      4: BEGIN
           ...
           BerekenMetEuler{Voeg voor parameteroverdracht variabelen
                           uit de globale constante- en variabele-
                           declaratie toe.};

...
import cx.prutser.xmlmath.schemas.GreaterThanType;
 ...
 */
public class GreaterThan extends AbstractBooleanValue {

	/**
	 * Whether the check should be <i>greater than or equals to</i>, rather
	 * than just <i>greater than</i>.
	 */
	...
	/**
	 * @return <tt>true</tt> if <tt>arg1</tt> is greater than <tt>arg2</tt>.
	 * If inclusive is set, also returns <tt>true</tt> when <tt>arg1</tt> is
	 * greater than, or equal to <tt>arg2</tt>.
	 */
	@Override
	...
	protected void build(ValueType xmlObject) throws ParseException {
		...
		GreaterThanType xml = (GreaterThanType)xmlObject;

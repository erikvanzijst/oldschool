/*
 * File:           ErikconfigurationParser.java
 ...
 * translates all related events into ErikconfigurationHandler events.
 * <p>Usage sample:
 * <pre>
 *    ErikconfigurationParser parser = new ErikconfigurationParser(...);
 *    parser.parse(new InputSource("..."));
 * </pre>
 * <p><b>Warning:</b> the class is machine generated. DO NOT MODIFY</p>
 *
 */
public class ErikconfigurationParser implements ContentHandler {
    
    private java.lang.StringBuffer buffer;
    
    private ErikconfigurationParslet parslet;
    
    private ErikconfigurationHandler handler;
     ...
     *
     */
    public ErikconfigurationParser(final ErikconfigurationHandler handler, final EntityResolver resolver, final ErikconfigurationParslet parslet) {
    ...
    private void dispatch(final boolean fireOnlyIfMixed) throws SAXException {
        ...
        } else if ("messagingDomain".equals(here)) {
            if (fireOnlyIfMixed) throw new IllegalStateException("Unexpected characters() event! (Missing DTD?)");
            handler.handle_messagingDomain(parslet.messagingDomainConvertor(buffer.length() == 0 ? null : buffer.toString()), attrs);
        ...
        } else if ("messagingAgent".equals(here)) {
            if (fireOnlyIfMixed) throw new IllegalStateException("Unexpected characters() event! (Missing DTD?)");
            handler.handle_messagingAgent(parslet.messagingAgentConvertor(buffer.length() == 0 ? null : buffer.toString()), attrs);
     ...
     *
     */
    public static void parse(final InputSource input, final ErikconfigurationHandler handler, final ErikconfigurationParslet parslet) throws SAXException, javax.xml.parsers.ParserConfigurationException, java.io.IOException {
        parse(input, new ErikconfigurationParser(handler, null, parslet));
    }
     ...
     *
     */
    public static void parse(final java.net.URL url, final ErikconfigurationHandler handler, final ErikconfigurationParslet parslet) throws SAXException, javax.xml.parsers.ParserConfigurationException, java.io.IOException {
        parse(new InputSource(url.toExternalForm()), handler, parslet);
    }
    
    private static void parse(final InputSource input, final ErikconfigurationParser recognizer) throws SAXException, javax.xml.parsers.ParserConfigurationException, java.io.IOException {
